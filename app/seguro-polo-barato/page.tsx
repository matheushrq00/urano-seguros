...
export const metadata = {
  title: "Seguro Polo barato em Limeira | Economize até 30%",
  description:
    "Descubra como pagar mais barato no seguro do Polo. Compare seguradoras e economize até 30% com cotação rápida.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Seguro Polo barato em Limeira</h1>
        ...
        <p>
          Se você quer pagar mais barato no seguro do seu Polo, saiba que existem
      ...
      {/* INTRO */}
      <section style={container}>
        <h2>É possível pagar barato no seguro do Polo?</h2>
        ...
        <p>
          Com uma análise correta e comparando seguradoras, é possível reduzir
      ...
      {/* PREÇO */}
      <section style={container}>
        <h2>Quanto custa um seguro Polo barato?</h2>

        <p>
          Um seguro mais econômico pode ficar entre 
          <strong> R$ 1.500 e R$ 2.800 por ano</strong>.
        </p>
      ...
      <section style={container}>
        ...
        <ul>
          ...
          <li><a href="/seguro-polo-motorista-novo">Motorista novo</a></li>
        </ul>
      </section>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Descubra agora o seguro mais barato para seu Polo.
        </p>
