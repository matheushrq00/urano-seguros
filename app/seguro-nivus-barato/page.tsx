...
export const metadata = {
  title: "Seguro Nivus barato em Limeira com até 30% OFF | Cotação rápida",
  description:
    "Encontre seguro barato para Nivus em Limeira. Compare seguradoras, economize até 30% e faça sua cotação rápida pelo WhatsApp.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Seguro Nivus barato em Limeira com até 30% de desconto</h1>

        <p style={highlight}>
          ✔️ Compare várias seguradoras <br />
          ✔️ Economize no seguro do seu Nivus <br />
        ...
        <p>
          Se você quer pagar menos no seguro do seu Volkswagen Nivus,
      ...
      {/* INTRO */}
      <section style={container}>
        <h2>Como encontrar seguro barato para Nivus?</h2>

        <p>
          O segredo para pagar menos no seguro do Nivus é comparar seguradoras
          e ajustar a cobertura de acordo com o seu perfil.
        </p>

        <p>
          Muitas pessoas acabam pagando mais caro por não fazer uma cotação correta.
        </p>
      </section>
      ...
      {/* PREÇO */}
      <section style={container}>
        <h2>Quanto custa um seguro barato para Nivus?</h2>
        ...
        <p>
          Com a estratégia certa, é possível economizar até 30% ou mais.
        </p>
      ...
      {/* DICAS */}
      <section style={container}>
        <h2>Dicas para pagar mais barato no seguro do Nivus</h2>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Aproveite agora e pague menos no seguro do seu Nivus.
        </p>
