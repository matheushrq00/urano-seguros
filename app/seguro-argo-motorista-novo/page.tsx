export const metadata = {
  title: "Seguro Argo para motorista novo em Limeira | Veja como pagar menos",
  description:
    "Descubra quanto custa o seguro do Fiat Argo para motorista novo e como economizar. Cotação rápida e personalizada.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Seguro Argo para motorista novo em Limeira</h1>
        ...
        <p>
          Se você é motorista novo e tem um Fiat Argo, é importante saber que o valor do seguro pode ser mais alto.
        </p>
      ...
      {/* INTRO */}
      <section style={container}>
        <h2>Seguro do Argo para motorista novo é mais caro?</h2>

        <p>
          Sim. Motoristas com pouca experiência apresentam maior probabilidade de acidentes,
          o que aumenta o risco para as seguradoras.
        </p>

        <p>
          Por esse motivo, o valor do seguro tende a ser mais elevado nesse perfil.
        </p>

        <p>
          Porém, existem formas inteligentes de reduzir esse custo.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <p>
          O seguro do Argo para motorista novo pode variar entre 
          <strong> R$ 2.200 e R$ 4.800 por ano</strong>.
        </p>
        ...
        <p>
          Cada perfil é analisado individualmente, por isso a cotação personalizada é essencial.
        </p>
      ...
      <section style={container}>
        ...
        <ul>
          <li><a href="/seguro-argo">Seguro Argo</a></li>
          <li><a href="/seguro-argo-barato">Seguro barato</a></li>
          <li><a href="/seguro-argo-quanto-custa">Quanto custa</a></li>
        </ul>
      </section>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Veja quanto custa o seguro do seu Argo sendo motorista novo.
        </p>
