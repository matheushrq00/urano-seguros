...
export default function Page() {
  ...
  const whatsappLink =
    "https://wa.me/5519998722063?text=Olá,%20quero%20simular%20o%20seguro%20para%20Polo%20em%20Limeira";
  ...
  return (
    <main style={main}>
      ...
      <section style={hero}>
        <Image
          id="hero-img"
          src="/images/polo-hero.png"
          alt="Volkswagen Polo em estrada para seguro em Limeira"
          fill
          priority
          style={heroImg}
        />
        ...
        <div style={heroContent}>
          <h1 style={title}>
            Seguro Polo em Limeira com até 30% de desconto
          </h1>

          <p style={subtitle}>
            Veja quanto custa o seguro do Polo e compare seguradoras em poucos minutos.
          </p>

          <a href={whatsappLink} style={btnPrimary}>
            Simular seguro do Polo
          </a>
        </div>
      </section>
      ...
      <section style={container}>
        <h2>Seguro para Volkswagen Polo é caro?</h2>

        <p>
          O Volkswagen Polo é um hatch moderno, com boa valorização no mercado, o que pode influenciar no preço do seguro.
        </p>

        <p>
          Ainda assim, é possível encontrar valores competitivos, principalmente ao comparar seguradoras e ajustar as coberturas conforme o perfil do motorista.
        </p>

        <p>
          Motoristas com bom histórico e uso moderado do veículo tendem a pagar menos pelo seguro do Polo.
        </p>
      </section>
      ...
      <section style={container}>
        <div style={priceBox}>
          ...
          <h2>Quanto custa o seguro do Polo em Limeira em 2024?</h2>

          <p>
            O valor pode variar conforme idade do condutor, local de uso e histórico de direção.
          </p>

          <p>
            Em média, o seguro do Polo fica entre <strong>R$ 1.400 e R$ 3.200 por ano</strong>.
          </p>

          <p>
            Para obter um valor exato, o ideal é fazer uma cotação personalizada.
          </p>
          ...
          <p style={highlightText}>
            Descubra agora quanto você vai pagar no seguro do seu Polo:
          </p>
        ...
        <div style={highlightContainer}>
          ...
          <div>
            <h2 style={highlightTitle}>
              Compare seguradoras e economize no seguro do seu Polo
            </h2>

            <p style={highlightDesc}>
              Em poucos minutos você encontra a melhor opção de seguro para o seu perfil.
            </p>
          ...
          <div style={imageWrapper}>
            <Image
              src="/images/whatsapp-cotacao-polo.png"
              alt="Simulação de seguro do Polo pelo WhatsApp"
              width={900}
              height={900}
      ...
      {/* COBERTURAS */}
      <section style={container}>
        <h2>O que o seguro do Polo cobre?</h2>
      ...
      {/* INTERLINK */}
      <section style={container}>
        <h2>Outros seguros populares</h2>
