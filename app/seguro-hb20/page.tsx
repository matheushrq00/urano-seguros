...
export const metadata = {
  ...
  description:
    "Descubra quanto custa o seguro do HB20 em Limeira. Veja valores reais, compare seguradoras e faça sua cotação rápida.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        ...
        <p>
          Se você tem um HB20, aqui você descobre quanto custa o seguro e como pagar
        ...
        <div style={box}>
          ...
          <ul>
            ...
            <li>✔️ Especialista em seguro de HB20</li>
          </ul>
        </div>
      ...
      <section style={container}>
        ...
        <p>
          O seguro do HB20 em Limeira pode variar entre 
      ...
      {/* FATORES */}
      <section style={container}>
        <h2>O que influencia o preço do seguro HB20?</h2>

        <div style={grid}>
          <div style={card}>Idade do motorista</div>
          <div style={card}>Ano e versão do HB20</div>
      ...
      {/* ECONOMIA */}
      <section style={container}>
        <h2>Como pagar mais barato no seguro HB20?</h2>
      ...
      <section style={container}>
        ...
        <p>
          Sim. Mesmo sendo um carro popular, o HB20 pode gerar prejuízos altos
