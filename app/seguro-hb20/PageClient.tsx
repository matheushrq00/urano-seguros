...
export default function Page() {
  ...
  const whatsappLink =
    "https://wa.me/5519998722063?text=Olá,%20quero%20simular%20o%20seguro%20para%20HB20%20em%20Limeira";
  ...
  return (
    <main style={main}>
      ...
      <section style={hero}>
        <Image
          id="hero-img"
          src="/images/hb20-hero.png"
          alt="Hyundai HB20 para seguro em Limeira"
          fill
          priority
          style={heroImg}
        />
        ...
        <div style={heroContent}>
          <h1 style={title}>
            Seguro HB20 em Limeira com até 30% de desconto
          </h1>

          <p style={subtitle}>
            Descubra quanto custa o seguro do HB20 e compare seguradoras em poucos minutos.
          </p>

          <a href={whatsappLink} style={btnPrimary}>
            Simular seguro do HB20
          </a>
        </div>
      </section>
      ...
      <section style={container}>
        <h2>Seguro para Hyundai HB20 vale a pena?</h2>

        <p>
          O Hyundai HB20 é um dos carros mais populares do Brasil, conhecido pelo baixo custo de manutenção e bom valor de revenda.
        </p>

        <p>
          Por ser um modelo bastante comum, o seguro tende a ter preços acessíveis, especialmente para motoristas com bom histórico.
        </p>

        <p>
          Comparar seguradoras é essencial para encontrar as melhores condições e economizar no seguro do HB20.
        </p>
      </section>
      ...
      <section style={container}>
        <div style={priceBox}>
          ...
          <h2>Quanto custa o seguro do HB20 em Limeira em 2024?</h2>

          <p>
            O valor do seguro do HB20 pode variar de acordo com o perfil do motorista, idade, região e uso do veículo.
          </p>

          <p>
            Em média, os preços ficam entre <strong>R$ 1.100 e R$ 2.900 por ano</strong>, podendo mudar conforme as coberturas escolhidas.
          </p>

          <p>
            Para saber o valor exato, o ideal é fazer uma cotação personalizada com diferentes seguradoras.
          </p>
          ...
          <p style={highlightText}>
            Descubra agora quanto você vai pagar no seguro do seu HB20:
          </p>
        ...
        <div style={highlightContainer}>
          ...
          <div>
            <h2 style={highlightTitle}>
              Compare seguradoras e economize no seguro do seu HB20
            </h2>

            <p style={highlightDesc}>
              Faça sua cotação online e encontre a melhor opção de seguro para o seu perfil.
            </p>
          ...
          <div style={imageWrapper}>
            <Image
              src="/images/whatsapp-cotacao-hb20.png"
              alt="Simulação de seguro HB20 pelo WhatsApp"
              width={900}
              height={900}
