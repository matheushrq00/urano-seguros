export const metadata = {
  title: "Seguro Corolla em Limeira | Cotação rápida e até 30% mais barato",
  description:
    "Seguro para Toyota Corolla com cotação rápida em Limeira. Compare seguradoras e economize até 30% no seguro.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Seguro para Corolla em Limeira</h1>
        ...
        <p>
          Se você tem um Toyota Corolla, proteger seu carro com um seguro completo
        ...
        <a href="https://wa.me/5519998722063" target="_blank" style={btnBig}>
          🚀 Fazer cotação do meu Corolla agora
        </a>
        ...
        <div style={box}>
          ...
          <ul>
            ...
            <li>✔️ Especialista em seguro de Corolla</li>
          </ul>
        </div>
      ...
      {/* SOBRE */}
      <section style={container}>
        <h2>Por que fazer seguro para Corolla?</h2>

        <p>
          O Corolla é um dos sedãs mais vendidos do Brasil, com alto valor de mercado
          e custo de reparo elevado. Além disso, é um modelo visado para roubo em
          algumas regiões.
        </p>

        <p>
          Ter um seguro garante proteção financeira e tranquilidade no dia a dia.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <p>
          O valor do seguro pode variar entre 
          <strong> R$ 2.000 e R$ 5.500 por ano</strong>, dependendo do perfil do motorista
          e uso do veículo.
        </p>
      ...
      <section style={container}>
        ...
        <div style={grid}>
          ...
          <div style={card}>Versão do Corolla</div>
        </div>
      </section>

      {/* COBERTURA */}
      <section style={container}>
        <h2>O que o seguro do Corolla cobre?</h2>
      ...
      {/* ECONOMIA */}
      <section style={container}>
        <h2>Como economizar no seguro do Corolla?</h2>
        ...
        <p>
          Nós fazemos essa análise para você e encontramos o melhor custo-benefício.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <ul>
          ...
          <li><a href="/seguro-corolla-motorista-novo">Seguro Corolla motorista novo</a></li>
        </ul>
      </section>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Descubra quanto você vai pagar no seguro do seu Corolla.
        </p>
