export const metadata = {
  title: "Seguro Auto em Limeira com até 30% OFF | Cotação em 2 Minutos",
  description:
    "Seguro auto em Limeira com desconto. Compare seguradoras e faça sua cotação rápida pelo WhatsApp com especialista.",
};
    ...
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        ...
        <p style={highlight}>
          ...
          ✔️ Atendimento rápido e sem burocracia
        </p>
      ...
      {/* INTRO SEO + VENDA */}
      <section style={container}>
        <h2>Seguro auto em Limeira com melhor custo-benefício</h2>

        <p>
          Se você está procurando <strong>seguro auto em Limeira</strong>, aqui você encontra
          as melhores opções com atendimento rápido, transparente e focado em economia.
        </p>

        <p>
          Trabalhamos com as principais seguradoras do Brasil para garantir o melhor
          preço, comparando coberturas e condições ideais para o seu perfil.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <p>
          ...
          dependendo do perfil do motorista, modelo do carro e região.
        </p>
      ...
      <section style={container}>
        ...
        <p>
          Você pode personalizar a cobertura conforme sua necessidade e orçamento.
        </p>
      </section>

      {/* CTA INTERMEDIÁRIO */}
      <section style={container}>
        <h2>Quer saber o valor no seu caso?</h2>
      ...
      <section style={container}>
        ...
        <ul>
          <li>Evitar prejuízos altos com acidentes</li>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Descubra quanto você pode economizar no seu seguro auto em Limeira.
        </p>
