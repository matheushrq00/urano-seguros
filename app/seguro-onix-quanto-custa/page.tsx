export const metadata = {
  title: "Quanto custa o seguro do Onix em Limeira? Veja valores e economize até 30%",
  description:
    "Descubra quanto custa o seguro do Onix em Limeira, veja preços atualizados e faça sua cotação rápida pelo WhatsApp.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Quanto custa o seguro do Onix em Limeira?</h1>
        ...
        <p>
          Se você tem um Chevrolet Onix e quer saber quanto custa o seguro,
          aqui você encontra valores reais e como pagar mais barato.
        </p>

        <a href="https://wa.me/5519998722063" target="_blank" style={btnBig}>
          🚀 Ver valor do meu Onix agora
        </a>
      ...
      {/* PREÇO */}
      <section style={container}>
        <h2>Qual o valor do seguro do Onix?</h2>

        <p>
          O seguro do Onix em Limeira pode variar entre 
          <strong> R$ 1.200 e R$ 3.200 por ano</strong>.
        </p>

        <p>
          Esse valor depende do perfil do motorista, ano do veículo e região.
        </p>
      ...
      {/* FATORES */}
      <section style={container}>
        <h2>O que influencia o preço do seguro do Onix?</h2>

        <div style={grid}>
          <div style={card}>Idade do motorista</div>
          <div style={card}>Ano do Onix</div>
          <div style={card}>Localização (Limeira)</div>
      ...
      {/* ECONOMIA */}
      <section style={container}>
        <h2>Como pagar mais barato no seguro do Onix?</h2>
      ...
      <section style={container}>
        ...
        <p>
          Sim. O Onix é um dos carros mais vendidos do Brasil, e isso também
          aumenta o risco de roubo e acidentes.
        </p>

        <p>
          O seguro garante proteção financeira e tranquilidade.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Descubra agora quanto você vai pagar no seguro do seu Onix.
        </p>
