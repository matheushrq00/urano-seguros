...
export const metadata = {
  title: "Seguro Creta para motorista novo em Limeira | Veja como pagar menos",
  description:
    "Descubra quanto custa o seguro do Creta para motorista novo e como economizar. Cotação rápida e personalizada.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Seguro Creta para motorista novo em Limeira</h1>
        ...
        <p>
          Se você é motorista novo e tem um Creta, o valor do seguro pode ser
      ...
      {/* INTRO */}
      <section style={container}>
        <h2>Seguro do Creta para motorista novo é mais caro?</h2>
      ...
      {/* PREÇO */}
      <section style={container}>
        <h2>Quanto custa o seguro do Creta para motorista novo?</h2>
      ...
      <section style={container}>
        ...
        <p>
          Pequenas decisões podem gerar grande economia.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Veja quanto custa o seguro do seu Creta sendo motorista novo.
        </p>
