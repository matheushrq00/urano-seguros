export const metadata = {
  title: "Seguro Creta em Limeira | Cotação rápida e até 30% mais barato",
  description:
    "Seguro para Hyundai Creta com cotação rápida em Limeira. Compare seguradoras e economize até 30%.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Seguro para Creta em Limeira</h1>
        ...
        <p>
          Se você tem um Hyundai Creta, proteger seu carro com um seguro completo
        ...
        <a href="https://wa.me/5519998722063" target="_blank" style={btnBig}>
          🚀 Fazer cotação do meu Creta agora
        </a>
      ...
      {/* SOBRE */}
      <section style={container}>
        <h2>Por que fazer seguro para Creta?</h2>

        <p>
          O Creta é um SUV muito popular no Brasil, com alto valor de mercado e
          custo elevado de reparo.
        </p>

        <p>
          Além disso, é um modelo bastante visado, o que torna o seguro essencial.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <p>
          ...
          <strong> R$ 2.000 e R$ 4.800 por ano</strong>, dependendo do perfil do motorista.
        </p>
      ...
      <section style={container}>
        ...
        <div style={grid}>
          ...
          <div style={card}>Versão do Creta</div>
        </div>
      </section>
      ...
      {/* ECONOMIA */}
      <section style={container}>
        <h2>Como economizar no seguro do Creta?</h2>
      ...
      <section style={container}>
        ...
        <ul>
          ...
          <li><a href="/seguro-creta-motorista-novo">Seguro Creta motorista novo</a></li>
        </ul>
      </section>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Descubra quanto você vai pagar no seguro do seu Creta.
        </p>
