export const metadata = {
  title: "Quanto custa o seguro do Nivus em Limeira? Veja preços e economize até 30%",
  description:
    "Descubra quanto custa o seguro do Nivus em Limeira, veja valores atualizados e faça sua cotação rápida pelo WhatsApp.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Quanto custa o seguro do Nivus em Limeira?</h1>
      ...
      {/* PREÇO */}
      <section style={container}>
        <h2>Qual o valor do seguro do Nivus?</h2>

        <p>
          O seguro do Nivus pode variar entre 
          <strong> R$ 1.500 e R$ 3.800 por ano</strong>.
        </p>

        <p>
          Esse valor depende do perfil do motorista, versão do veículo e região.
        </p>
      ...
      {/* FATORES */}
      <section style={container}>
        <h2>O que influencia o preço do seguro do Nivus?</h2>

        <div style={grid}>
          <div style={card}>Idade do motorista</div>
          <div style={card}>Versão do Nivus</div>
          <div style={card}>Localização (Limeira)</div>
          <div style={card}>Uso (Uber ou pessoal)</div>
        </div>

        <p>
          Cada detalhe influencia diretamente no valor final do seguro.
        </p>
      </section>
      ...
      {/* ECONOMIA */}
      <section style={container}>
        <h2>Como pagar mais barato no seguro do Nivus?</h2>
      ...
      <section style={container}>
        ...
        <p>
          Sim. O Nivus é um carro moderno e valorizado, o que aumenta os custos
          em caso de roubo ou colisão.
        </p>
