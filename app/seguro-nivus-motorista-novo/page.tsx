...
export const metadata = {
  ...
  description:
    "Descubra quanto custa o seguro do Nivus para motorista novo e como economizar até 30%. Faça sua cotação rápida.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Seguro do Nivus para motorista novo é caro?</h1>
        ...
        <p>
          Se você é motorista novo e tem um Volkswagen Nivus, é normal o seguro ser mais caro.
          Mas existem formas de reduzir bastante esse valor — e aqui você vai descobrir como.
        </p>
      ...
      <section style={container}>
        ...
        <p>
          Porém, isso não significa que você precisa pagar caro — apenas que precisa fazer a cotação certa.
        </p>
      </section>

      {/* PREÇO */}
      <section style={container}>
        <h2>Quanto custa o seguro do Nivus para motorista novo?</h2>

        <p>
          O valor pode variar entre <strong>R$ 2.200 e R$ 5.500 por ano</strong>.
        </p>
      ...
      <section style={container}>
        ...
        <p>
          Um acidente pode gerar um prejuízo alto — e o seguro evita isso.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <ul>
          ...
          <li><a href="/seguro-nivus-vale-a-pena">Vale a pena fazer seguro</a></li>
        </ul>
      </section>
