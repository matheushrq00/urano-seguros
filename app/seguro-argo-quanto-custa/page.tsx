export const metadata = {
  ...
  description:
    "Descubra quanto custa o seguro do Fiat Argo em Limeira, média de preços e como economizar até 30%.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Quanto custa o seguro do Argo em Limeira?</h1>
        ...
        <p>
          Se você quer saber quanto custa o seguro do Argo, saiba que o valor pode variar bastante
      ...
      {/* PREÇO */}
      <section style={container}>
        <h2>Qual o valor do seguro do Argo?</h2>

        <p>
          O seguro do Argo pode variar bastante dependendo do perfil do motorista.
        </p>
      ...
      {/* ECONOMIA */}
      <section style={container}>
        <h2>Como pagar mais barato no seguro do Argo?</h2>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Veja quanto você pode economizar no seguro do seu Argo.
        </p>
