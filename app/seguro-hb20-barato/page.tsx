...
export const metadata = {
  title: "Seguro HB20 barato em Limeira com até 30% OFF | Cotação rápida",
  description:
    "Encontre seguro barato para HB20 em Limeira. Compare seguradoras, economize até 30% e faça sua cotação rápida pelo WhatsApp.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Seguro HB20 barato em Limeira com até 30% de desconto</h1>

        <p style={highlight}>
          ✔️ Compare várias seguradoras <br />
          ✔️ Economize no seguro do seu HB20 <br />
        ...
        <p>
          Se você quer pagar menos no seguro do seu HB20, aqui você encontra
          as melhores opções com o menor preço e atendimento especializado.
        </p>
      ...
      {/* INTRO */}
      <section style={container}>
        <h2>Como encontrar seguro barato para HB20?</h2>

        <p>
          O segredo para pagar menos no seguro do HB20 é comparar seguradoras
          e ajustar a cobertura de acordo com o seu perfil.
        </p>

        <p>
          Muitas pessoas pagam mais caro simplesmente por não fazer uma cotação correta.
        </p>
      </section>
      ...
      {/* PREÇO */}
      <section style={container}>
        <h2>Quanto custa um seguro barato para HB20?</h2>
      ...
      {/* DICAS */}
      <section style={container}>
        <h2>Dicas para pagar mais barato no seguro do HB20</h2>
      ...
      <section style={container}>
        ...
        <p>
          O importante é equilibrar preço e proteção.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Aproveite agora e pague menos no seguro do seu HB20.
        </p>
