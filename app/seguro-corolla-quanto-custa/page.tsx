...
export const metadata = {
  title: "Quanto custa o seguro do Corolla em Limeira? Veja preços e economize até 30%",
  description:
    "Descubra quanto custa o seguro do Corolla em Limeira. Veja valores reais, compare seguradoras e faça sua cotação rápida.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Quanto custa o seguro do Corolla em Limeira?</h1>
        ...
        <p>
          Se você tem um Corolla, aqui você descobre quanto custa o seguro e como pagar
          mais barato com uma cotação personalizada.
        </p>

        <a href="https://wa.me/5519998722063" target="_blank" style={btnBig}>
          🚀 Ver valor do meu Corolla agora
        </a>
      ...
      {/* PREÇO */}
      <section style={container}>
        <h2>Qual o valor do seguro do Corolla?</h2>

        <p>
          O seguro do Corolla em Limeira pode variar entre 
      ...
      {/* FATORES */}
      <section style={container}>
        <h2>O que influencia o preço do seguro do Corolla?</h2>

        <div style={grid}>
          <div style={card}>Idade do motorista</div>
          <div style={card}>Ano e versão do Corolla</div>
      ...
      {/* BENEFÍCIO */}
      <section style={container}>
        <h2>Vale a pena fazer seguro para Corolla?</h2>

        <p>
          Sim. O Corolla é um dos sedãs mais valorizados e também muito visado,
          o que torna o seguro essencial para evitar prejuízos.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Descubra agora quanto você vai pagar no seguro do seu Corolla.
        </p>
