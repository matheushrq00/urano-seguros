...
export const metadata = {
  title: "Seguro T-Cross para motorista novo em Limeira | Veja como pagar menos",
  description:
    "Descubra quanto custa o seguro do T-Cross para motorista novo e como economizar. Cotação rápida e personalizada.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Seguro T-Cross para motorista novo em Limeira</h1>
        ...
        <p>
          Se você é motorista novo e tem um T-Cross, o valor do seguro pode ser
      ...
      {/* INTRO */}
      <section style={container}>
        <h2>Seguro do T-Cross para motorista novo é mais caro?</h2>
      ...
      {/* PREÇO */}
      <section style={container}>
        <h2>Quanto custa o seguro do T-Cross para motorista novo?</h2>

        <p>
          O valor pode variar entre 
          <strong> R$ 3.000 e R$ 6.500 por ano</strong>, dependendo do perfil.
        </p>
      ...
      <section style={container}>
        ...
        <div style={grid}>
          <div style={card}>Adicionar condutor mais experiente</div>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Veja quanto custa o seguro do seu T-Cross sendo motorista novo.
        </p>
