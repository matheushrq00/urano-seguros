...
export const metadata = {
  title: "Seguro Argo vale a pena? Veja quando compensa",
  description:
    "Descubra se vale a pena fazer seguro do Fiat Argo, quanto custa e quando compensa contratar.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        ...
        <p>
          Se você está em dúvida se vale a pena fazer seguro para o Fiat Argo,
      ...
      {/* RESPOSTA DIRETA */}
      <section style={container}>
        <h2>Vale a pena fazer seguro do Argo?</h2>
        ...
        <p>
          Mesmo sendo um carro popular, o Argo ainda possui um valor considerável
          e custos de reparo que podem pesar no bolso em caso de acidente.
        </p>

        <p>
          Um simples imprevisto pode gerar um prejuízo maior do que o valor anual do seguro.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <div style={grid}>
          ...
          <div style={card}>Trânsito intenso</div>
          <div style={card}>Risco de roubo</div>
          <div style={card}>Quer evitar prejuízos</div>
        </div>

        <p>
          Nesses casos, o seguro é altamente recomendado.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <div style={grid}>
          ...
          <div style={card}>Baixa exposição ao trânsito</div>
          <div style={card}>Perfil muito conservador</div>
        </div>

        <p>
          Mesmo assim, é importante avaliar caso a caso.
        </p>
      </section>
      ...
      <section style={container}>
        ...
        <p>
          Para a maioria das pessoas, o seguro do Argo vale a pena sim,
