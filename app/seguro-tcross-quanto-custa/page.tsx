...
export const metadata = {
  title: "Quanto custa o seguro do T-Cross em Limeira? Veja preços e economize até 30%",
  description:
    "Descubra quanto custa o seguro do T-Cross em Limeira. Veja valores reais, compare seguradoras e faça sua cotação rápida.",
};
  ...
  return (
    <main style={{ background: "#f5f7fa" }}>
      ...
      <section style={container}>
        <h1>Quanto custa o seguro do T-Cross em Limeira?</h1>
        ...
        <p>
          Se você tem um T-Cross, aqui você descobre quanto custa o seguro e como pagar
          mais barato com uma cotação personalizada.
        </p>

        <a href="https://wa.me/5519998722063" target="_blank" style={btnBig}>
          🚀 Ver valor do meu T-Cross agora
        </a>
      ...
      {/* PREÇO */}
      <section style={container}>
        <h2>Qual o valor do seguro do T-Cross?</h2>

        <p>
          O seguro do T-Cross em Limeira pode variar entre 
          <strong> R$ 2.000 e R$ 4.500 por ano</strong>.
        </p>
      ...
      {/* FATORES */}
      <section style={container}>
        <h2>O que influencia o preço do seguro do T-Cross?</h2>

        <div style={grid}>
          <div style={card}>Idade do motorista</div>
          <div style={card}>Ano e versão do T-Cross</div>
      ...
      {/* ECONOMIA */}
      <section style={container}>
        <h2>Como pagar mais barato no seguro do T-Cross?</h2>
      ...
      {/* BENEFÍCIO */}
      <section style={container}>
        <h2>Vale a pena fazer seguro para T-Cross?</h2>

        <p>
          Sim. O T-Cross possui alto valor de mercado e custo elevado de reparo,
      ...
      <section style={container}>
        ...
        <ul>
          <li><a href="/seguro-tcross">Seguro T-Cross</a></li>
      ...
      <section style={container}>
        ...
        <p style={{ fontWeight: "bold", fontSize: "18px" }}>
          Descubra agora quanto você vai pagar no seguro do seu T-Cross.
        </p>
