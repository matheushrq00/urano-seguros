    ...
    <section className="section--segments" id="segmentos">
      <div className="segmentsWrap">
        ...
        <div className="segmentsGrid">
          <a className="segmentCard" href="/para-voce">
            ...
            <p className="segmentDesc">
              Auto, vida, residencial e mais — do seu jeito.
            </p>

            <span className="segmentCta">Ver opções →</span>
          </a>

          <a className="segmentCard" href="/para-empresas">
            <div className="segmentTop">
              <div className="segmentIcon">
                <IconBusiness />
              </div>
            ...
            <p className="segmentDesc">
              Proteção completa para o seu negócio crescer seguro.
            </p>

            <span className="segmentCta">Ver opções →</span>
          </a>

          <a className="segmentCard" href="/produtos-financeiros">
            <div className="segmentTop">
              <div className="segmentIcon">
                <IconFinance />
              </div>
            ...
            <p className="segmentDesc">
              Consórcio e soluções para planejar com inteligência.
            </p>
...
function IconUser() {
  return (
    <svg viewBox="0 0 24 24" fill="none">
      ...
      <path d="M12 13a4 4 0 1 0-4-4 4 4 0 0 0 4 4Z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
    </svg>
  );
}
...
function IconBusiness() {
  return (
    <svg viewBox="0 0 24 24" fill="none">
      ...
      <path d="M7 8h2M7 12h2M7 16h2M15 12h2M15 16h2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
    </svg>
  );
}
...
function IconFinance() {
  return (
    <svg viewBox="0 0 24 24" fill="none">
      ...
      <path d="M19 8v3h-3" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
